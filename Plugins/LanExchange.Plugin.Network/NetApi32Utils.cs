...
namespace LanExchange.Plugin.Network
{
    public class NetApi32Utils
    {
        ...
        /// <returns></returns>
        public IEnumerable<NetApi32.SERVER_INFO_101> NetServerEnum(string domain, NetApi32.SV_101_TYPES types)
        {
            IntPtr pInfo;
            uint entriesread = 0;
            uint totalentries = 0;
        ...
        public IEnumerable<NetApi32.SHARE_INFO_1> NetShareEnum(string computer)
        {
            IntPtr pInfo;
            int entriesread = 0;
            int totalentries = 0;
