...
namespace WMIViewer.Model
{
    ...
    internal static class WmiHelper
    {
        internal static DateTime ToDateTime(string wmiDate)
        {
            ...
            var dmtf = wmiDate;
            string tempString;
            if (dmtf == null) throw new ArgumentOutOfRangeException(nameof(wmiDate));
            if (dmtf.Length == 0) throw new ArgumentOutOfRangeException(nameof(wmiDate));
            if (dmtf.Length != 25) throw new ArgumentOutOfRangeException(nameof(wmiDate));
            try
            {
                ...
                if ((year < 0) || (month < 0) || (day < 0) ||
                    (hour < 0) || (minute < 0) || (minute < 0) || (second < 0) || (ticks < 0))
                {
