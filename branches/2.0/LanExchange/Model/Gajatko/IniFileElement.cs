...
namespace LanExchange.Model.Gajatko.IniFiles
{
	/// <summary>Base class for all Config File elements.</summary>
	internal class IniFileElement
	{
		private string line;
	...
	internal class IniFileSectionStart : IniFileElement
	{
	...
	internal class IniFileBlankLine : IniFileElement
	{
	...
	internal class IniFileCommentary : IniFileElement
	{
	...
	internal class IniFileValue : IniFileElement
	{
		private string key;
