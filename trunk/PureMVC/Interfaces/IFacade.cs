...
namespace PureInterfaces
{
    ...
    /// </remarks>
	/// <see cref="PureInterfaces.IModel"/>
	/// <see cref="PureInterfaces.IView"/>
	/// <see cref="PureInterfaces.IController"/>
	/// <see cref="PureInterfaces.ICommand"/>
