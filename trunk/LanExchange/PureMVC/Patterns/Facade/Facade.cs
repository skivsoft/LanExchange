...
namespace PureMVC.PurePatterns
{
    ...
    ///     </example>
    /// </remarks>
	/// <see cref="PureCore.Model"/>
	/// <see cref="PureCore.View"/>
	/// <see cref="PureCore.Controller"/>
	/// <see cref="PurePatterns.Notification"/>
	/// <see cref="PurePatterns.Mediator"/>
	/// <see cref="PurePatterns.Proxy"/>
	/// <see cref="PurePatterns.SimpleCommand"/>
	/// <see cref="PurePatterns.MacroCommand"/>
