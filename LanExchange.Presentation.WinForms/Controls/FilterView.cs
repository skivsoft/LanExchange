...
namespace LanExchange.Presentation.WinForms.Controls
{
    internal sealed partial class FilterView : UserControl, IFilterView
    {
        ...
        public void EditFilter_TextChanged(object sender, EventArgs e)
        {
        ...
        private void ImageClear_MouseHover(object sender, EventArgs e)
        {
            imgClear.Image = Resources.clear_hover;
        }

        private void ImageClear_MouseLeave(object sender, EventArgs e)
        {
